...
@section('content')
    ...
    <h1 class="text-2xl font-bold mb-4">Edit Penyakit</h1>
        <div class="bg-white shadow-md rounded-lg p-6">
            <form action="{{ route('penyakit.update', $penyakit->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama_penyakit" value="{{ $penyakit->nama_penyakit }}" class="w-full border border-gray-300 px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                </div>
                <div class="mb-4">
                    <label for="kode_penyakit" class="block text-gray-700 font-semibold mb-2">Kode Penyakit</label>
                    <input type="text" name="kode_penyakit" value="{{ $penyakit->kode_penyakit }}" class="w-full border border-gray-300 px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                </div>
