        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form action="{{ route('penyakit.store') }}" method="POST">
                ...
                <div class="flex justify-end">
                    <button type="submit" class="bg-blue-500 text-white px-4 py-2 mr-3 rounded-md transition duration-300 ease-in-out transform hover:bg-blue-600 hover:scale-105">
                        Simpan
                    </button>
                    <a href="{{ route('daftar-penyakit') }}" 
                       class="bg-red-500 text-white px-4 py-2 rounded-md transition duration-300 ease-in-out transform hover:bg-red-600 hover:scale-105">
                        Batal
                    </a>
                </div>
            </form>
